...
void publish_measurements(void){
  ...
  payload.replace("schema_name", "test_schema_ints");//"schema_name", "test_schema_ints"
  payload.replace("field0_value", "0");//field0_value", "0"
  payload.replace("field1_value", "1");//"field1_value", "1")
  Serial.printf("Publishing measurements with payload: %s\r\n", payload.c_str());
